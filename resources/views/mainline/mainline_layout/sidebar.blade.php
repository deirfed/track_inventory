    ...
    <ul class="nav">
      ...
      <li class="nav-item animate__animated animate__fadeInLeft">
        ...
        <div class="collapse" id="form-elements">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item animate__animated animate__fadeInLeft"><a class="nav-link" href="pages/forms/basic_elements.html">List Temuan</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item animate__animated animate__fadeInLeft">
        ...
        <div class="collapse" id="charts">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item animate__animated animate__fadeInLeft"> <a class="nav-link" href="pages/charts/chartjs.html">ChartJs</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item animate__animated animate__fadeInLeft">
        ...
        <div class="collapse" id="tables">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item animate__animated animate__fadeInLeft"> <a class="nav-link" href="pages/tables/basic-table.html">Basic table</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item animate__animated animate__fadeInLeft">
        ...
        <div class="collapse" id="icons">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item animate__animated animate__fadeInLeft"> <a class="nav-link" href="pages/icons/mdi.html">Mdi icons</a></li>
          </ul>
        </div>
      </li>
      ...
      <li class="nav-item animate__animated animate__fadeInLeft">
        ...
        <div class="collapse" id="auth">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item animate__animated animate__fadeInLeft"> <a class="nav-link" href="pages/samples/login.html"> Login </a></li>
          </ul>
        </div>
      </li>
    </ul>
