                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="Input Area Name">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">Area Code</label>
                      <input type="email" class="form-control" id="exampleInputEmail3" placeholder="Input Area Code">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Location</label>
                        <select class="form-control" name="detailarea" id="">
